  ...
  return (
    <div className="w-full flex flex-wrap pl-7 justify-start rounded-3xl bg-white gap-12  mt-[1%]">
      {cows.slice(0, 5).map((cow) => (
        <div
          key={cow.id}
          className="w-70 bg-white flex flex-col border-green-700 rounded-2xl"
        >
          <div className="ml-[5%] mt-2 w-[90%] h-[80%]">
            <div className="relative h-[300px] border-red-500">
              ...
              <div className="absolute z-10 w-[90%] left-[5%] mt-[10%] rounded-2xl h-[50%]">
                <img
                  src={cow.photos[0]}
                  alt={cow.name}
          ...
          <div className="ml-[8%] mt-[-30%] h-[28%] w-[84%]">
            ...
            <div className="h-[20%] w-full flex">
              ...
              <p className="text-black ml-[4%] font-bold text-sm">
                {cow.purchase_status}
              </p>
            </div>
          </div>
