...
const CenterBanner = () => {
 ...
 const nn='>>';
  ...
  <div className="h-[65%]  rounded-2xl flex justify-between items-center overflow-visible relative">
    ...
    >
        ...
        <div className='w-full  ml-[20%] flex items-start' >
            <button className="bg-white text-black font-semibold px-8 py-2 rounded-lg shadow hover:bg-gray-100 transition duration-200">
               BUY NOW
            </button>     
        </div>
  ...
  <div className='w-full  flex justify-between items-end flex-1 h-[35%]'>
       ...
       <div className='border w-[49.2%] bg-[rgb(138,134,134)] h-[92%] flex rounded-3xl'>
        <div className='w-[50%] h-full  flex flex-col justify-center  items-center'>
