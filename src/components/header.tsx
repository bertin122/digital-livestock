      ...
      <div className="min-h-[80px] flex items-center  w-full bg-green-500">
        <div className="w-[88%] ml-[6%] h-[100%]  border-red-400 bg-green-500 flex justify-between items-center">
          ...
          {localStorage.getItem("token") && (
            <button
              className="inline-flex items-center gap-2 text-white px-4 py-2 rounded-lg shadow hover:bg-gray-800 transition"
          ...
          <button
            className="relative inline-flex items-center gap-2  text-white px-4 py-2 rounded-lg shadow hover:bg-gray-800 transition"
          ...
          >
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13l-1.35 2.7a1 1 0 00.9 1.5h11.1M7 13L5.4 5H3"
              />
            </svg>
