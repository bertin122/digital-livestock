...
const Home = () => {
  return (
   <div className="bg-[rgb(216,209,209)] w-full h-600 flex flex-col overflow-y-auto">


        <div className='w-full  border-red-800 h-[7%]'>
                 {/* insert header */}
        </div>
        <div className='h-[8%] w-full bg-green-500'>
        ...
        <div className='h-[60%]   ml-[5%] mt-[1%] w-[90%]  border-red-500 justify-between flex '>
            <div className='h-full bg-white w-[20%] rounded-2xl  border-red-500'>
                <div className='h-[10%]  border-red-400 flex items-center'>
                    <p className='text-md  ml-[17%] font-bold text-red-500'>SALE 40% OFF </p>
                </div>
                <div className='h-[7%] w-full  border-black flex items-center' >
                      <p className='text-md ml-[17%] font-bold'>Cows</p>
                </div>
                <div className='h-[7%] w-full  border-black flex items-center' >
                      <p className='text-md  ml-[17%] font-bold'>Bulls</p>
                </div>
                <div className='h-[7%] w-full  border-black flex items-center' >
                      <p className='text-md  ml-[17%] font-bold'>Cows</p>
                </div>
        ...
        <div className='w-[90%] ml-[5%] mt-[1%]  h-[20%]'>
            ...
            <CowCard/>
            <div className='w-[90%] ml-[5%] mt-[2%]  border'>
                  <div className='bg-green-500 flex items-center rounded-2xl w-full h-25'>
                      <p className='ml-[3%] text-white font-bold text-2xl'>ALL CATEGORIES</p>
                  </div>
                  <div className='w-full border flex justify-start gap-12 mt-[1%] '>
                       <Cow/>
                  </div>
